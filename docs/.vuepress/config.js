...
module.exports = {
  ...
  plugins: [
      ...
      "vuepress-plugin-player",
      {
        ...
        localSongs: {
          ...
          songs: [
            ...
            {
              path: "/music/1.mp3",
              songName: "Old Memory-市川淳",
              cover:
                "https://p2.music.126.net/OpgpNNPKznDDMxoBqVJy-Q==/2464005557906815.jpg?param=130y130",
            },
            {
              path: "/music/2.mp3",
              songName: "アゲイン - 横山克",
            ...
            // 4
            {
              ...
              songName: "潮鳴り - 折戸伸治",
              cover:
                "https://p1.music.126.net/PtLd62-khEg8iCutTdE5Vg==/109951163286813093.jpg?param=130y130",
            },
            {
              path: "/music/5.mp3",
              songName: "追憶の丘",
              cover:
                "https://p2.music.126.net/wAuYY5Ye0kIeA7oVC_RRrw==/7898891534571736.jpg?param=130y130",
            },
            {
              path: "/music/6.mp3",
              songName: "I SAY YES(wedding version) - 光宗信吉",
              cover:
                "https://p1.music.126.net/7cnrQkv1dGsnuU7R3yc0tQ==/5953855464416745.jpg?param=130y130",
            },
            {
              path: "/music/7.mp3",
              songName: "運命の夜 - 川井憲次,佐々木寿子",
              cover:
                "https://p1.music.126.net/U0Tf2ESHBauv2F9t1PgEZA==/109951163339713541.jpg?param=130y130",
            },
            {
              path: "/music/8.mp3",
              songName: "ヨスガノソラ メインテーマ -遠い空へ-  - 市川淳",
              cover:
                "https://p1.music.126.net/OpgpNNPKznDDMxoBqVJy-Q==/2464005557906815.jpg?param=130y130",
            },
            {
              path: "/music/9.mp3",
              songName: "NEXT TO YOU - Ken Arai",
              cover:
                "https://p2.music.126.net/SVJNKYtlB_n9I7p0017Ndw==/6635552674995921.jpg?param=130y130",
            },
            {
              path: "/music/10.mp3",
    ...
    [
      "vuepress-plugin-live2d-plus",
      {
        enable: true,
        model: {
          url: "https://cdn.jsdelivr.net/gh/qsyyke/vscode-live2d-models/model-library/bilibili-22/index.json",
        },
        display: {
          position: "right",
          width: "135px",
  ...
  head: [
    ...
    //   "script",
    //   {
    //     // src: "https://at.alicdn.com/t/c/font_3586210_bxwuv0m4nv.js",
    //   },
    // ],
    //设置站点icon
    [
      "link",
      {
        href: "/avatar_circle.png",
        rel: "icon",
      },
    ],
    // 这个是我自己加的,若有冲突后面的会覆盖前面的
    // [
    //   "link",
    //   {
    //     rel: "stylesheet",
    //     type: "text/css",
    //     href: "//at.alicdn.com/t/c/font_3586210_bxwuv0m4nv.css",
    //   },
    // ],
    // 原来就有的
    [
  ...
  themeConfig: {
    ...
    repo: "https://github.com/niconiconiQwQ",

    //自定义GitHub的图标
    repoIconClass: "aurora-navbar-github",

    //md文件的仓库地址
    docsRepo: "https://github.com/niconiconiQwQ/notes",
    ...
    //网站开始时间，请按照以下格式进行
    startRunTime: "11/7/2022 12:22:00",
    ...
    customTopImg: {
      ...
      page: ["/bg/555260.png", "/bg/404901.png", "/bg/734386.png"],
      //友情链接页面
      friend: ["/bg/669.png", "/bg/5332.png"],
      //标签页面
      tag: ["/bg/763311.png"],
      //心情页面
      mood: ["/bg/5849.png"],
    ...
    //手机端首页背景图片
    homeWpsMobile: ["/bg/4.jpg", "/bg/5.jpg"],
    ...
    //侧边栏配置
    //github地址
    githubUrl: "https://github.com/niconiconiQwQ",
     ...
     * 一下是v1.11.1版本增加的配置
     * */
    afDianUrl: "https://www.baidu.com", //你的爱发电个人页面地址
